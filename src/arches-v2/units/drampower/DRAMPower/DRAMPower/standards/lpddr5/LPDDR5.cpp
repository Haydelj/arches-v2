...
#include <units/drampower/DRAMPower/DRAMPower/standards/lpddr5/core_calculation_LPDDR5.h>
#include <units/drampower/DRAMPower/DRAMPower/standards/lpddr5/interface_calculation_LPDDR5.h>
#include <iostream>
