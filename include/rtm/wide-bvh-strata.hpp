...
public:
	WideBVHSTRaTA(const rtm::BVH2& bvh2, std::vector<rtm::BVH2::BuildObject>& build_objects)
	{
		printf("Building Wide BVH for STRaTA\n");
		...
		printf("Built Wide BVH for STRaTA\n");
	}

	~WideBVHSTRaTA() = default;
